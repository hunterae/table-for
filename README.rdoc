...
formatter::
  ...
  or a Proc (which will be passed the value requiring formatting,
  based on the current column's name. The :formatter argument will only work if the column name has been specified.
  ...
  be specified as the formatter, or a series of method names (shown in examples below):
    <%= table_for @users |table| %>
      ...
      <% table.column :full_name, :formatter => [:gsub, /d/, "*"] %>
